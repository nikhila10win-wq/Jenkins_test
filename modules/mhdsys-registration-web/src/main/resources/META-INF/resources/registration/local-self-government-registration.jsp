			...
			<div class="col-md-12">
				<div class="border-0 card shadow">
					<%-- <div class="card-header d-flex align-item-center justify-content-between">
						<h5><liferay-ui:message key="local-self-government-registration"/></h5>						
					</div> --%>
				...
				<form id="register_school_college"> 
					...
					<div class="card card-background p-0">
					 <div class="card-header header-card"><liferay-ui:message key="local-self-government-registration"/></div>
					<input type="hidden" class="form-control" id="regType" name="regType" value="LocalSelfGov" />					
						<div class="card-body">
						<div class="row">
							<div class="col-md-3">
