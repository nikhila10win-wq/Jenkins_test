		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card-body">
					...
					<div class="card-header header-card"><liferay-ui:message key="school-college-education-institutions"/></div>
					<input type="hidden" class="form-control" id="regType" name="regType" value="SchoolCollege" />					
						...
						<div class="col-md-6">
								<div class="form-group">
									<label><liferay-ui:message key="udise-code"/></label>
									<input type="text" class="form-control" name="udiseCode" id="udiseCode" value=""/>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
