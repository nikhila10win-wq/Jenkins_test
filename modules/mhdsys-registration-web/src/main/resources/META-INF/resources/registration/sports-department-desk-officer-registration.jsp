			...
			<div class="col-md-12">
				<div class="border-0 card shadow">
					<%-- <div class="card-header d-flex align-item-center justify-content-between">
						<h5><liferay-ui:message key="sports-department-desk-officer"/></h5>						
					</div> --%>
					
					<div class="align-items-center back-btn-cn card-header d-flex justify-content-between">
						<h5 class="mb-0">
							<liferay-ui:message key="sports-department-officer" />
						</h5>
						<div>
				...
				<form id="register_school_college"> 
					...
					<div class="card card-background p-0">
					 <div class="card-header header-card"><liferay-ui:message key="sports-department-officer"/></div>
					<input type="hidden" class="form-control" id="regType" name="regType" value="Desk Officer" />					
						<div class="card-body">
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-6">
							    <div class="form-group">
							        ...
							        <select class="form-control" name ="departmentName" id="departmentName">
										...
										<option value="Department1"><liferay-ui:message key="Department1"/></option>
										<option value="Department2"><liferay-ui:message key="Department2"/></option>
									</select>
							    </div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name ="subDepartment" id="subDepartment">
										<option value=""><liferay-ui:message key="select"/></option>
										<option value="SubDepartment1"><liferay-ui:message key="SubDepartment1"/></option>
										<option value="SubDepartment2"><liferay-ui:message key="SubDepartment2"/></option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label><liferay-ui:message key="employee-id"/><sup class="text-danger">*</sup></label>
...
<!-- 									<input type="text" class="form-control" name="designation" id="designation" value=""/>
 -->									<select class="form-control" name ="designation" id="designation">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label><liferay-ui:message key="landline-no"/></label>
						...
						<div class="row">
							...
							<div class="col-md-6">
											<div class="form-group">
												<label>
												<liferay-ui:message key="text-verification-code" /><sup class="text-danger">*</sup></label>
						...
						<div class="card-footer bg-transparent text-right p-4">
							...
							<%-- <button type="button" class="btn btn-primary" onclick="document.getElementById('register_school_college').reset();"><liferay-ui:message key="reset" /></button> --%>
...
$(document).ready(function () {
	...
	rules:{
		...
		departmentName: {
			required:"<liferay-ui:message key="please-select-department-name"/>",
			/* minlength:"<liferay-ui:message key="please-enter-at-least-3-characters"/>",
			maxlength:"<liferay-ui:message key="please-enter-no-more-than-75-characters"/>", */
		},
		subDepartment: {
			required:"<liferay-ui:message key="please-select-subdepartment-name"/>",
			/* minlength:"<liferay-ui:message key="please-enter-at-least-3-characters"/>",
			maxlength:"<liferay-ui:message key="please-enter-no-more-than-75-characters"/>", */
		},
		officialName: {
		...
		employeeId: {
			required:"<liferay-ui:message key="please-enter-employee-id"/>",
			minlength:"<liferay-ui:message key="please-enter-at-least-3-characters"/>",
			maxlength:"<liferay-ui:message key="please-enter-no-more-than-20-characters"/>",
		},
		secretaryName: {
