			...
			<div class="col-md-12">
				<div class="border-0 card shadow">
 					<%--<div class="card-header d-flex align-item-center justify-content-between">
						<h5><liferay-ui:message key="sports-associations-registration"/></h5>						
					</div> --%>
				...
				<form id="register_school_college"> 
					...
					<div class="card card-background p-0">
					 <div class="card-header header-card"><liferay-ui:message key="sports-associations-registration"/></div>
					<input type="hidden" class="form-control" id="regType" name="regType" value="Association" />
					<div class="card-body">
						<div class="row">
							<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-6">
							    <div class="form-group">
							        <label for="ageGroupUnder14"><liferay-ui:message key="name-of-association" /><sup class="text-danger">*</sup></label>
							        <input type="text" class="form-control" id="associationName" name="associationName" value="" />
							    </div>
							</div>

							<div class="col-md-6">
								<div class="form-group">
									<label><liferay-ui:message key="association-registration-no"/><sup class="text-danger">*</sup></label>
									<input type="text" class="form-control" id="associationRegNo" name="associationRegNo" value="" />
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
							    <div class="form-group">
							        <label for="ageGroupUnder14"><liferay-ui:message key="association-type" /><sup class="text-danger">*</sup></label>
							        <input type="text" class="form-control" id="associationType" name="associationType" value="" />
							    </div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label><liferay-ui:message key="aadhar-no-of-secretary-chairman"/><sup class="text-danger">*</sup></label>
...
$(document).ready(function () {
	...
	rules:{
		...
		associationName: {
			required:"<liferay-ui:message key="please-enter-association-name"/>",
		...
		associationRegNo: {
			required:"<liferay-ui:message key="please-enter-association-reg-no"/>",
			minlength:"<liferay-ui:message key="please-enter-at-least-3-characters"/>",
		...
		associationType:{
			required:"<liferay-ui:message key="please-enter-association-type"/>",
			minlength:"<liferay-ui:message key="please-enter-at-least-3-characters"/>",
			maxlength:"<liferay-ui:message key="please-enter-no-more-than-75-characters"/>",
		},
	    captchaInput: {
