...
@Component(immediate = true, property = { "javax.portlet.name=" + MhdsysGrievanceComplaintWebPortletKeys.MHDSYSGRIEVANCECOMPLAINTWEB,
		"javax.portlet.name=" + MhdsysGrievanceComplaintWebPortletKeys.MHDSYSGRIEVANCEPUBLISHEDLISTWEB,
		"mvc.command.name=" + MhdsysGrievanceComplaintWebPortletKeys.GET_DISTRICTS }, service = MVCResourceCommand.class)
