...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Grievance",
		...
		"javax.portlet.display-name=MhdsysGrievanceComplaintWeb", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsps/grievance-complaint-register.jsp",
...
public class MhdsysGrievanceComplaintWebPortlet extends MVCPortlet {
	private Log LOGGER = LogFactoryUtil.getLog(MhdsysGrievanceComplaintWebPortlet.class);
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		try {
			...
			if(user.getEmailAddress().contains("default")) {
				isGuestUser = true;
			}else {
				isGuestUser = false;
			}
		...
		renderRequest.setAttribute("isGuestUser", isGuestUser);
