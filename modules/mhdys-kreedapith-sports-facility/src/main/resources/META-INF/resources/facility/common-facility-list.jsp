									...
									<form id="facility_filter_form" method="POST">
										 <div class="card-body">
									        <div class="row">
									            ...
									            <div class="col-md-3">
									                <label><liferay-ui:message key="facility-Area" /></label>
									                <input type="text" class="form-control" id="facility-Area" />
									            </div>
									            <div class="col-md-3">
                        ...
                        <table id="facility-list" class="table-bordered" width="100%">
						    <thead>
						        <tr>
						            ...
						            <th><liferay-ui:message key="facility-Area" /></th>
...
var table = $('#facility-list').DataTable({
    ...
    "initComplete": function() {
        ...
        $('#searchBtn').click(function (e) {
            ...
            let facilityArea = $('#facility-Area').val().trim();
            ...
            if (modifiedDate) table.column(7).search(modifiedDate);
