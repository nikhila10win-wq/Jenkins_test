            ...
            <div class="col-md-12">
                <div class="border-0 card shadow">
                    ...
                    <div class="align-items-center back-btn-cn card-header d-flex justify-content-between" style="">
						...
						<div><a href="/group/guest/dashboard" class="btn btn-primary btn-sm rounded-pill back-btn-cn"><i class="bi bi-arrow-left-circle mr-1"></i>  <liferay-ui:message key="back" /></a></div>
					</div>
                    ...
                    <div class="card-body">
						...
						<div class="filter-container">
							...
							<!-- Filter Card -->
							<div class="card filter-card mt-2 card-background p-0" id="filterCard">
                    ...
                    <form id="reviewForm" method="POST" enctype="multipart/form-data">
                    	...
                    	<div class="">
                        <table id="facility-list" class="table-bordered" cellspacing="0" width="100%">
						    <thead>
						        <tr>
						    ...
						    <tbody>
						        <c:forEach var="tracker" items="${filteredList}" varStatus="status">
						            <tr>
						                ...
						                <td><a href="${redirectUrl}&facilityBookingId=${tracker.facilityBookingId}" class="btn btn-primary"><i class="bi bi-credit-card-2-front" title="<liferay-ui:message key="entry-pass" />"></i></a></td>
						            </tr>
						        </c:forEach>
						    </tbody>
						</table>
