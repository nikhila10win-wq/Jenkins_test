							...
							<form id="approve-form">
								<div class="row mt-3">
									<div class="col-md-12 text-right">
											<button class="btn btn-primary submitBtn"  disabled><liferay-ui:message key="distribute-applications-to-sports-desk-officers" /></button>
									</div>
								</div>
							</form>
					</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-bg">
					<div class="modal-header justify-content-center align-items-center">
						<h5 class="modal-title" id="exampleModalLongTitle"><liferay-ui:message key="distribute-applications-to-sports-desk-officers"/></h5>
	 ...
	 jQuery.noConflict();
        ...
        $('#filterBtn').on('click', function () {debugger
            ...
            if (roleNameValue || sportNameValue) {
                table.column(5).search(roleNameValue).column(2).search(sportNameValue).draw();
            } else {
                table.column(5).search('').column(2).search('').draw(); 
            }
        });
 }); */
