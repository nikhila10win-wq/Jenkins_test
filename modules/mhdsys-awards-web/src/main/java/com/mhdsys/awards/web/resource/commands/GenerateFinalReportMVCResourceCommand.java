...
@Component(immediate = true, property = { "javax.portlet.name=" + AwardsWebPortletKeys.MHDSYSAWARDSWEB,
		...
		"mvc.command.name=" + AwardsWebPortletKeys.GENERATE_FINAL_REPORT }, service = MVCResourceCommand.class)
public class GenerateFinalReportMVCResourceCommand implements MVCResourceCommand {
	...
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try (PDPageContentStream contentStream = new PDPageContentStream(document, page,
			...
			String[] headers = { "Comp. Date", "Sports Name", "Comp. Level", "Comp. Name", "Medal Received",
					"Award Year", "HO Marks", "HO Remark" };
			...
			for (AwardApplication application : applications) {
				...
				String[] rowData = { formatDate(application.getCompetitionStartDate()),
						sportName, compLevel,
						...
						application.getAwardPointByHo() != null ? application.getAwardPointByHo() : "N/A",
						application.getOverallHoRemarks() != null ? application.getOverallHoRemarks() : "N/A" };
