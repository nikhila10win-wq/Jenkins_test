...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Awards",
		...
		"javax.portlet.display-name=MhdsysAwardsApplicationListWeb", "javax.portlet.init-param.template-path=/",
		...
		"javax.portlet.init-param.view-template=" + AwardsCommonConstants.AWARDS_APPLICATION_LIST_FOR_DESK_OFFICER_JSP,
		"javax.portlet.name=" + AwardsWebPortletKeys.AWARDS_APPLICATION_LIST_MANAGEMENTWEB,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)
public class AwardsApplicationListWebPortlet extends MVCPortlet {
