...
<#-- Access the ExpandoBridge for the user -->
<#assign expandoBridge = user.getExpandoBridge() />

<#-- Get the "Profile Verification" attribute from the ExpandoBridge -->
<#assign isProfileVerified = expandoBridge.getAttribute("IsProfileUpdated") />


<#if isProfileVerified && isSignedIn>
