...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Budget",
		...
		"javax.portlet.display-name=MhdsysBudgetAddition", "javax.portlet.init-param.template-path=/",
		...
		"javax.portlet.init-param.view-template=/budget/budget-addition.jsp",
		"javax.portlet.name=" + MhdsysBudgetWebPortletKeys.MHDSYSBUDGETADDITION,
		"javax.portlet.resource-bundle=content.Language",
		"com.liferay.portlet.requires-namespaced-parameters=false",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)

public class MhdsysBudgetAdditionPortlet extends MVCPortlet {

	
	private Log LOGGER = LogFactoryUtil.getLog(MhdsysBudgetAdditionPortlet.class);

	@Override
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {
		try {
			LOGGER.info("Budget Addition Portlet");
