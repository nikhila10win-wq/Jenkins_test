...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Budget",
		...
		"javax.portlet.display-name=MhdsysFundsDistribution", "javax.portlet.init-param.template-path=/",
		...
		"javax.portlet.init-param.view-template=/budget/funds-distribution.jsp",
...
public class MhdsysFundsDistributionPortlet extends MVCPortlet {

	private Log LOGGER = LogFactoryUtil.getLog(MhdsysFundsDistributionPortlet.class);

	@Override
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {
		try {
			LOGGER.info("Fund Distribution Portlet");
