...
@Component(immediate = true, property = { "javax.portlet.name=" + MhdsysBudgetWebPortletKeys.MHDSYSBUDGETWEB,
		...
		"mvc.command.name=" + MhdsysBudgetWebPortletKeys.GETDISTRICTS }, service = MVCResourceCommand.class)

public class GetDistrictsMVCResourceCommand implements MVCResourceCommand{

	
	private Log LOGGER = LogFactoryUtil.getLog(GetDistrictsMVCResourceCommand.class);
