...
property = {
		...
		"mvc.command.name="+SportsCoachinWingMvcCommand.VIEW_MONTHLY_REPORT
		},
service = MVCRenderCommand.class)
public class ViewMonthlyReportMvcRenderCommand implements MVCRenderCommand {
	
	public static final Log _log=LogFactoryUtil.getLog(ViewMonthlyReportMvcRenderCommand.class.getName());
	
	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		_log.info("ViewMonthlyReportMvcRenderCommand  render ::");
		 String redirectPage="/coachingwing-monthly-report.jsp";
		 ...
		 _log.info("ViewMonthlyReportMvcRenderCommand :: coachingWingMonthlyReportId :::"+coachingWingMonthlyReportId);
		 _log.info("mode :::" +mode);
