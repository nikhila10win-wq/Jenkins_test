				...
				<div class="border-0 card shadow">
					...
					<div class="card-body">
						...
						<div class="filter-container">
							...
							<form id="award-winner-filter" method="POST">
									<div class="card-body">
										<div class="row">
										    <div class="col-md-3">
					...
					<div class="universal-table mt-4">
						<table id="award-winner-table" class="table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
					...
					<tbody>
					 <c:forEach var="award" items="${awardWinnerList}">
					 
					 <portlet:renderURL var="awardWinnerViewURL">
						...
						<portlet:param name="awardWinnerId" value="${award.awardWinnerId }"></portlet:param>
						<portlet:param name="mode" value="view"></portlet:param>
						<portlet:param name="application" value="award"></portlet:param>
					 </portlet:renderURL>
					 ...
					 <%-- <portlet:renderURL var="budgetEditURL">
						...
						<tr>
							...
							<td>${award.mobileNumber}</td>
							<td>
							<div class="tooltip-icon">
						                           <ul class="inline-item">
						                            <li class="list-inline-item">
						                           <c:if test="${!isDeskOfficer && !isDeputyDirector }">
								<a class="btn btn-sm btn-primary" href="${awardWinnerViewURL}"><i class="bi bi-eye icons-color" title="<liferay-ui:message key="view" />"></i></a>
							</c:if>
						                            </li>
						                             <li class="list-inline-item">
						                            <c:if test="${isDeskOfficer || isDeputyDirector}">
								<a class="btn btn-sm btn-primary" href="${awardWinnerViewURL}"><i class="bi bi-eye icons-color" title="<liferay-ui:message key="verify" />"></i></a>
							</c:if></li>
						                            </ul>
						                        </div>
...
var table = $('#award-winner-table').DataTable({
    "paging": true,
    "ordering": false,
    "searching": true,
    "responsive": true,
