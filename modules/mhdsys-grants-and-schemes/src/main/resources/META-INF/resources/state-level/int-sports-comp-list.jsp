				...
				<div class="border-0 card shadow">
					...
					<div class="card-body">
						...
						<div class="filter-container">
							...
							<form id="int-sports-comp-filter" method="POST">
									<div class="card-body">
										<div class="row">
										    <div class="col-md-3">
					...
					<div class="universal-table mt-4">
						<table id="int-sports-comp-table" class="table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
...
var table = $('#int-sports-comp-table').DataTable({
    "paging": true,
    "ordering": false,
    "searching": true,
    "responsive": true,
...
$('#resetBtn').click(function() {
    ...
    if (typeof table !== 'undefined') {
        ...
        $('.int-sports-comp-filter input').val('');
    }
});
