				...
				<div class="border-0 card shadow">
					...
					<div class="card-body">
						...
						<div class="filter-container">
							...
							<form id="council-filter" method="POST">
									<div class="card-body">
										<div class="row">
										    <div class="col-md-3">
					...
					<div class="universal-table mt-4">
						<table id="council-table" class="table-bordered" cellspacing="0" width="100%">
					<thead>
						<tr>
...
var table = $('#council-table').DataTable({
    "paging": true,
    "ordering": false,
    "searching": true,
    "responsive": true,
