...
.common-forms-div .card .card-body  .btn-apply{
margin-bottom:0px;
}
}
			...
			<div class="col-md-12">
				<div class="border-0 card shadow">
					...
					<div class="card-body">
						...
						<c:if test="${!isDeskOfficer && !isDeputyDirector && !isHoAdmin}">
							<button type="button" class="btn btn-primary btn-apply" id="filterBtn" onclick="location.href='/group/guest/district-level-grant-and-scheme';">
						                     ...
						                     <ul class="inline-item">
													<c:if test="${!isDeskOfficer && !isDeputyDirector && !isHoAdmin}"> 
													    <li class="list-inline-item">
								                            ...
								                            <a class="btn btn-sm btn-primary" href="${applicationViewURL}"><i class="bi bi-eye icons-color" title="<liferay-ui:message key="view" />"></i></a></li>
												...
												<li class="list-inline-item">
												    <c:if test="${isDeskOfficer || isHoAdmin}">
												            <a href="${applicationEditURL}" class="btn btn-sm btn-primary">
												                <i class="bi bi-eye icons-color" 
												                   title="<liferay-ui:message key='${empty application.hoVerification ? "view-verify" : "view"}' />">
												                </i>
												            </a>
												    </c:if>
												    <c:if test="${isDeputyDirector}">
												            <a href="${applicationEditURL}" class="btn btn-sm btn-primary">
												                <i class="bi bi-eye icons-color" 
												                   title="<liferay-ui:message key='${empty application.ddVerification ? "view-verify" : "view"}' />">
												                </i>
												            </a>
												    </c:if>
												</li>
					...
					<div class="card-footer bg-transparent text-right p-4">
						<button type="button" class="btn btn-primary" id="filterBtn" onclick="location.href='/group/guest/download-application';">
							<liferay-ui:message key="download-grant-and-scheme-applications" />
						</button>
						
						<button type="button" class="btn btn-primary" id="filterBtn" onclick="location.href='/group/guest/distribute-fund';">
							<liferay-ui:message key="distribute-fund" />
						</button>
					</div>
				</c:if>
				</div>
