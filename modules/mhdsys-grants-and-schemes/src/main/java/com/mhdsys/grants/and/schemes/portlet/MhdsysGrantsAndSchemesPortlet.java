...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Grants And Schemes",
		...
		"javax.portlet.display-name=MhdsysGrantsAndSchemes", "javax.portlet.init-param.template-path=/",
...
public class MhdsysGrantsAndSchemesPortlet extends MVCPortlet {

	private static Log LOGGER = LogFactoryUtil.getLog(MhdsysGrantsAndSchemesPortlet.class);
