...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Grants And Schemes",
		...
		"javax.portlet.display-name=MhdsysFundDistribution", "javax.portlet.init-param.template-path=/",
		...
		"javax.portlet.init-param.view-template=/district-level/fund-distribution.jsp",
...
public class MhdsysFundDistributionPortlet extends MVCPortlet {

	private static Log LOGGER = LogFactoryUtil.getLog(MhdsysFundDistributionPortlet.class);
