...
@Component(property = { "com.liferay.portlet.display-category=MHDSYS.Grants And Schemes",
		...
		"javax.portlet.display-name=MhdsysDistrictLevelGrantsAndSchemes", "javax.portlet.init-param.template-path=/",
		...
		"javax.portlet.init-param.view-template=/district-level/district-level-grants-and-scheme-list.jsp",
...
public class MhdsysDistrictLevelGrantsAndSchemePortlet extends MVCPortlet {

	private static Log LOGGER = LogFactoryUtil.getLog(MhdsysDistrictLevelGrantsAndSchemePortlet.class);
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		try {
			...
			if (isDeskOfficer || isDeputyDirector || isHoAdmin) {
				...
				renderRequest.setAttribute("applicationList",
						DistrictGrantSchemeLocalServiceUtil.findByUserId(user.getUserId()));
			}
