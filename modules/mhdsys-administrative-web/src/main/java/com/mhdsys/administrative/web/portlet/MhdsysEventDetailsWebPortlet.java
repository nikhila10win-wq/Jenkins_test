...
@Component(
	property = {
		...
		"javax.portlet.display-name=MhdsysEventDetailsWeb",
		"javax.portlet.init-param.template-path=/",
		"com.liferay.portlet.requires-namespaced-parameters=false",
		"javax.portlet.init-param.view-template=/scout-and-guide/event-details.jsp",
...
public class MhdsysEventDetailsWebPortlet extends MVCPortlet {
	private Log LOGGER = LogFactoryUtil.getLog(MhdsysEventDetailsWebPortlet.class);
