...
@Component(immediate = true, property = { "javax.portlet.name=" + MhdsysAdministrativeWebPortletKeys.MHDSYSADDGRANTWEB,
		"mvc.command.name=" + MhdsysAdministrativeWebPortletKeys.SAVE_NCC_GRANT_MVC_RESOURCE_COMMAND }, service = MVCResourceCommand.class)
public class SaveNCCGrantMVCResourceCommand implements MVCResourceCommand{
	private Log LOGGER = LogFactoryUtil.getLog(SaveNCCGrantMVCResourceCommand.class);
