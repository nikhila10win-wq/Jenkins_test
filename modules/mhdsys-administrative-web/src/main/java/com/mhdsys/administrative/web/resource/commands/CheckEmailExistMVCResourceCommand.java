...
@Component(immediate = true, property = { "javax.portlet.name=" + MhdsysAdministrativeWebPortletKeys.MHDSYSSCOUTGUIDEREGWEB,
		"mvc.command.name=" + MhdsysAdministrativeWebPortletKeys.EMAIL_EXIST_URL }, service = MVCResourceCommand.class)
