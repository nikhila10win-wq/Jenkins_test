...
@Component(
	property = {
		...
		"javax.portlet.display-name=MhdsysAddGrantWeb",
		"com.liferay.portlet.requires-namespaced-parameters=false",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/ncc/unit-details.jsp",
...
public class MhdsysAddGrantsWebPortlet extends MVCPortlet {
	private Log LOGGER = LogFactoryUtil.getLog(MhdsysAddGrantsWebPortlet.class);
